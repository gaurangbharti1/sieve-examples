...
class Model:
    ...
    def __predict__(self, input_audio: sieve.Audio, process: str = "denoise", cfm_func_evals: int = 64, cfm_temp: float = 0.5):
        """
        :param input_audio: Audio to process
